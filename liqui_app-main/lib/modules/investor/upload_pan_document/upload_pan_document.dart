...
class UploadPanDocument extends GetView<UploadBankDocumentController> {
  const UploadPanDocument({Key? key}) : super(key: key);
    ...
    return Obx(() => SafeArea(
          child: Scaffold(
            ...
            body: OverlayScreen(
                ...
                backgroundColor: controller.overlayLoading.value ? Colors.white54 : Get.theme.scaffoldBackgroundColor,
                child: Padding(
                    ...
                    children: [
                      ...
                      controller.imagePath.value.isNotEmpty
                          ...
                          : MyOutlinedButton(
                              ...
                              title: "upload_pan_doc".tr),
                      MyButton(
                          margin: const EdgeInsets.all(padding0),
